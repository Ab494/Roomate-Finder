...
class ReviewListCreateView(APIView):
    def get(self, request):
        reviews = Review.objects.filter(reviewer=request.user).select_related("reviewer__profile", "reviewee__profile")
...
class UserReviewsView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        return Review.objects.filter(reviewee=user).select_related("reviewer__profile", "reviewee__profile")
