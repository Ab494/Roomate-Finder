    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('furnished', models.CharField(choices=[('furnished', 'Fully Furnished'), ('semi', 'Semi Furnished'), ('unfurnished', 'Unfurnished')], default='unfurnished', max_length=15)),
                ('status', models.CharField(choices=[('active', 'Active'), ('taken', 'Taken'), ('paused', 'Paused')], default='active', max_length=10)),
