...
class Preference(models.Model):
    ...
    min_budget = models.PositiveIntegerField(
        default=0, help_text="Minimum monthly budget in KES"
    )  # Min rent willing to pay
    max_budget = models.PositiveIntegerField(
        default=50000, help_text="Maximum monthly budget in KES"
    )  # Max rent willing to pay
    ...
    cleanliness = models.CharField(
        max_length=15, choices=CLEANLINESS_CHOICES, default=MODERATE
    )  # Preferred cleanliness level
    noise_tolerance = models.CharField(
        max_length=10, choices=NOISE_CHOICES, default=MODERATE_NOISE
    ...
    max_distance_km = models.PositiveIntegerField(
        default=10, help_text="Maximum distance from preferred area in km"
    )  # Max distance from preferred areas
